...
#artist, firstName of user, gender of user, item number in session, last name of user, length of the song, level (paid or free song),
# location of the user, sessionId, song title, userId
...
rows = session.execute(""" SELECT song , user_id, first_name , last_name 
